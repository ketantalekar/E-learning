...
%>
 ...
 <div id="student">
      ...
      ps6.setString(1,(String)session.getAttribute("subjectname1"));
      ...
      Students <input type="text" style="outline:none;"id="myInput6" onkeyup="myFunction()" placeholder="Search for student names.." title="Type in a name">
      </div>
      <hr class="new2">
      <div>
      <ul id="myUL">
     ...
     int sid=0;
      ...
      ps8.setString(1,(String)session.getAttribute("subjectname1"));
     ...
     // String studid="";
       ...
       {
    	   %>
    	   <li><a style="width:86.58%;display:inline-block;">
    	    ...
    	    <%=rs9.getString(1) %>
    	      ...
    	      <span >
    	   <a style="float:right;padding:26px;display:inline-block;"href="RemoveStudent.jsp?name=<%=sid%>">Remove</a>
    	   </span>
