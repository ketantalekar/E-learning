  ...
  <div class="container">
    <div class="row">
        <div class="col-10 mt-3">
            ...
            <form action="CAProfileValidation.jsp" method="post">
                   
                <div class="card-horizontal">
                    <div class="img-square-wrapper">
                    <%String user1=(String)session.getAttribute("sessuid"); %>
                        <img class="img-card" src="CollegeAdminViewImage.jsp?name=<%=user%>">
              
                    </div>
                    <div class="card-body">
                        <h3 class="card-title"><b>My Profile</b></h3>
                        <%
                        String query2="Select Username,Userid,Email_Id,Address,Mobile_No,College_Name,College_code,Date_of_Joining from college_admin_details where Userid=?";
                        PreparedStatement ps6=con1.prepareStatement(query2);
                        ps6.setString(1,user1);
                        ResultSet rs6=ps6.executeQuery();
                        String uname="",email="",address="",mobileno="",doj="",code="",clgname="";
                        if(rs6.next())
                        {
                      ...
                      clgname=rs6.getString(6);
                      code=rs6.getString(7);
                      doj=rs6.getString(8);
                        }
                        %>
                        <p class="card-text">
                        ...
                        <input type="text" autocomplete="off"name="uname" pattern="^[a-zA-Z ]+$"title="This field contains only alphabets"value="<%=uname %>" id="text-box"></div>
                        </p>
                        <p class="card-text">
                       ...
                       <p class="card-text">
                        ...
                        <input type="email" autocomplete="off"name="emailid" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"title="Valid Email Id required"value="<%=email %>" id="text-box"></div>
                      ...
                      <p class="card-text">
                       ...
                       <p class="card-text">
                           <div class="sub-title"> Date of Joining </div>
                             <div class="input-value">
                      
                        <input type="text" autocomplete="off"name="doj" value="<%=doj %>" id="text-box" readonly></div>
