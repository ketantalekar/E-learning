...
<div style="margin-left:60px;color:black;margin-top:10px;position:absolute;"><h3><i class="fas fa-chalkboard-teacher" aria-hidden="true"></i>&nbsp;Files</h3></div>
  ...
  <tr id="qq"><th>Id</th><th>Name</th><th>Modified Date</th><th>Modified by</th><th>Download</th><th>Remove</th></tr>
...
<td><%=cnt %></td>
<td id="fname"><a href="/E-learning/FacultyViewFile?filename=<%=fileName%>" target="_blank" style="text-decoration:none;"><%=fileName %></a></td><td><%=upload_date %></td>
<td><%=userid %></td>
<td id="tableicon"><a href="FacultyFileDownload.jsp?id=<%=id%>"><i class="fa fa-download" style="color:grey;font-size:25px;"aria-hidden="true"></i></td>
<td id="tableicon"></a><a href=""data-toggle="modal" data-target="#D<%=id%>"><i class="fa fa-trash" style="color:grey;font-size:25px;"aria-hidden="true"></i></a></td>
</tr>
