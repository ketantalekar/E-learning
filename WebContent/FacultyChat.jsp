      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class=" py-2 collapse-inner rounded"style="background-color:#E5E8E8;">
            ...
            <a class="collapse-item" href="FacultyChat.jsp">Faculty</a>
...
<nav id="head">Chats</nav>  
  ...
  <div id="top-private-bar">
  <form autocomplete="off"method="post"action="FacultyChatCheck.jsp">
	   ...
	   if(sen.equals(sender))
		  {
		   String recname="";
		      ...
		      recname=rs5.getString(1);
		   		   ...
		   		   %>
		   		   <a id="recent-chats-link"href="FacultyChatCheck.jsp?people=<%=recname%>"><div id="recent-chats">
