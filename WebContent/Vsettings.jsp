...
input[type="password"]:focus,#pass1:focus,#pass2:focus{
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="VendorDashboard.jsp">
...
%>
  <div id="main-panel">
<div id="heading">
<span id="title"><i class="fa fa-cog" aria-hidden="true"></i>&nbspSettings</span>
</div>
<div id="flip"><i id="key"class="fa fa-key" aria-hidden="true"></i> <span id="changepasshead">Change Password</span><br><span id="matter">It's a good idea to use a strong password that you're not using elsewhere</span><input id="button"type="button"value="Edit"></div>
<form action="vsettings_valid.jsp">
<div id="panel">Current <input id="pass1"type="password"name="currpass"placeholder="Current Password"required><br>
                New <input id="pass2"type="password"name="newpass"placeholder="New Password" required><br>
                Re-type new <input type="password"name="repass"placeholder="Retype New Password" required><br>
                <input id="button3"type="submit"name="updat"value="Save Changes"><br>
    
                </div>
</form>
</div>
<div id="flip1"><i class="fa fa-picture-o" aria-hidden="true"></i> <span id="changepasshead">Upload / Update Profile Pic</span><br><span id="matter">Radiate good vibes.</span><input id="button1"type="button"value="Edit"></div>  
<form method="post"action="/E-learning/UploadServlet"enctype="multipart/form-data">
<div id="panel1">Choose Photo &nbsp<input style="outline:none;"type="file" name="myimg"required><br><input id="button4"type="submit"name="update1"value="Upload"><br>
</div></form>
