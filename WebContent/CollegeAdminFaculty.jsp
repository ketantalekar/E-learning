      ...
      <ul class="navbar-nav ml-auto">
         <form class=" d-sm-inline-block form-inline mr-3 mt-1 ml-md-3 my-3 my-md-10 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-silver border-1 small" autocomplete="off"id="myInput6" onkeyup="myFunction()" placeholder="Search for faculty" aria-label="Search" aria-describedby="basic-addon2">
...
%>
  <div id="buttonss">
    ...
    <a href="" id="buttons"data-toggle="modal" data-target="#addfaculty" class="btn-room">Add Faculty</a>
    <div style="margin-left:70px;color:black;margin-top:15px;position:absolute;"><h3><i class="fas fa-chalkboard-teacher" aria-hidden="true"></i>&nbsp;Faculties</h3></div>
   </div>



    
  <div id="addfaculty" class="modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content" id="login-modal-content">        
          ...
          <form method="post" action="AddFaculty.jsp">
            ...
            <div class="input-group-prepend">
                ...
                <input name="facultyname"autocomplete="off" pattern="^[a-zA-Z ]+$"title="This field contains only alphabets"id="facultyname" type="text" class="form-control input-lg" placeholder="Enter Faculty Name" required>
                </div>                      
            </div>
            <p id="msg"></p>
                      <div class="form-group">
            ...
            <div class="input-group-prepend">
                ...
                <input name="emailid" autocomplete="off"id="emailid" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"title="Valid Email Id required"class="form-control input-lg" placeholder="Enter Email Id" required>
                </div>                      
            </div>
            <div class="form-group">
                    <div class="input-group input-group-md">
            ...
            <input type="submit" value="&#43; Add Faculty"style="background:#2980B9;color:white;outline:none;"class="btn btn-block btn-lg">
          </form>
        </div>
...
<tr>
<th> Faculty Name</th><th>Email Id</th><th>Mobile number</th><th>Action</th></tr>

<%
String query6="Select Username,Email_Id,Mobile_No,UserId,Address,Id from faculty_details";
String uid="";
int id=0;
...
while(rs6.next())
{
	...
	id=rs6.getInt(6);
	%>
	<tr><td><% out.println(rs6.getString(1)); %></td><td><% out.println(rs6.getString(2)); %></td>
	<td><% out.println(rs6.getString(3)); %></td>
	<td style="text-align:center;"><a href="" data-toggle="modal" data-target="#E<%=uid%>" style="background:#186A3B;color:white;"class="btn btn-md">Edit</a> 
	
	<a href="" data-toggle="modal" data-target="#D<%=uid%>"class="btn btn-md"style="background:#C0392B;color:white;">Remove</a></td></tr>
   ...
   <div class="modal-dialog" role="document"> 
     ...
     <!-- login modal content -->
        <div class="modal-content" id="login-modal-content">        
          ...
          <form method="post" action="EditFaculty.jsp">
            <div class="form-group">
            ...
            <div class="input-group-prepend">
                ...
                <input name="facultyname" id="facultyname" pattern="^[a-zA-Z ]+$"title="This field contains only alphabets"type="text" class="form-control input-lg" value="<%=rs6.getString(1)%>" required>
                </div>
                </div>                      
            <p id="msg"></p>
            ...
            <div class="input-group-prepend">
               ...
               <input name="emailid" id="emailid" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"title="Valid Email Id required"class="form-control input-lg" value="<%=rs6.getString(2)%>" required>
                </div>
                </div>                      
            ...
            <div class="input-group-prepend">
             ...
             <input name="mobileno" id="mobno" type="text"  pattern="[0-9]{10}"title="Valid Contact no required"class="form-control input-lg" value="<%=rs6.getString(3)%>" required>
                </div>
                </div>                      
              <div class="form-group">
            ...
            <input name="address" id="address" type="text" class="form-control input-lg" value="<%=rs6.getString(5) %>" required>
                </div>
                </div>                      
                        
                 <input name="uid" type="hidden"  value="<%=rs6.getString(4) %>" required>
           
            <button type="submit"style="background:#186A3B;color:white;" class="btn btn-block btn-lg"><i class="fas fa-edit"></i> Modify</button>
          </form>
        </div>
   ...
   <div class="modal-dialog modal-confirm" role="document"> 
     ...
     <!-- login modal content -->
      ...
      <div class="modal-footer justify-content-center">
				...
				<a href="DeleteFaculty.jsp?id=<%=id%>&fid=<%=uid %>" style="color:white;padding-top:10px;"class="btn btn-danger">Delete</a>
			</div>
...
%>
  ...
  function generatefacultyid()
  {
	  ...
	  if(facultyname=="")
		  ...
		  x.innerHTML ="<nav style='margin-left:0px;line-height:40px;width:467px;background:#E6B0AA;color:#C0392B;text-align:center;font-size:17px;'><i class='fa fa-times' aria-hidden='true'></i> Please enter Faculty name</nav>";
		} 
	  else
		  {
		  var x = document.getElementById("msg")
		  x.innerHTML ="";
	  var res = facultyname.substring(0, 4);
