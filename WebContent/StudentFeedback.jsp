...
%>
  ...
  <div class="col-lg-12">
  <div class="card-body">
  <form action="StudentFeedbackDB.jsp" method="post">
  <div class="card-title"><h2 class="text-center">Take a Survey</h2></div>
  <div class="mydivs">
  ...
  <h5>1. How would you describe yourself in one sentence?</h5>
      ...
      <textarea class="form-control" rows="3" cols="50" id="suggestions" name="question1" placeholder="Please enter your answer"></textarea>
    </div>
    <h5>2. What is your main goal for using this website/product?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="80" id="suggestions" name="question2" placeholder="Please enter your answer"></textarea>
    </div>
    <h5>3. What changed for you after you started using our product?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="80" id="suggestions" name="question3" placeholder="Please enter your answer"></textarea>
    </div>
    <h5>4. Where did you first hear about us?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="80" id="suggestions" name="question4" placeholder="Please enter your answer"></textarea>
    </div>
  </div>
  <div>
  ...
  <h5>5. How can we make this page better?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="50" id="suggestions" name="question5" placeholder="Please enter your answer"></textarea>
    </div>
    <h5>6. What’s the ONE thing our website is missing?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="80" id="suggestions" name="question6" placeholder="Please enter your answer"></textarea>
    </div>
    <h5>7. What are your main concerns or questions about [product or service]?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="80" id="suggestions" name="question7" placeholder="Please enter your answer"></textarea>
    </div>
    <h5>8. What do you like most about our [product or service]?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="80" id="suggestions" name="question8" placeholder="Please enter your answer"></textarea>
    </div>
  </div>
<div>
  ...
  <h5>9. What feature/option could we add to make your experience better?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="50" id="suggestions" name="question9" placeholder="Please enter your answer"></textarea>
    </div>
    <h5>10. How easy is it to navigate our website?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="80" id="suggestions" name="question10" placeholder="Please enter your answer"></textarea>
    </div>
    <h5>11. What originally attracted you to our website?
</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="80" id="suggestions" name="question11" placeholder="Please enter your answer"></textarea>
    </div>
    <h5>12. Do you have any other comments, questions, or concerns?</h5>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="3" cols="80" id="suggestions" name="question12" placeholder="Please enter your answer"></textarea>
    </div>
  </div>
  </div>
  <button type="button"name="prev" id="prev" class="btn btn-primary btn-lg center-block btnnav">Previous</button>
<button type="button"name="next" id="next" class="btn btn-primary btn-lg center-block btnnav">Next</button>
<button type="submit" name="submit" id="submit" class="btn btn-primary btn-lg center-block btnnav">Submit</button>
...
$(document).ready(function() {
 ...
 // hide all divs except first
    $("button[name=next]").click(function() {
       // document.write(divs.length);
        divs.eq(now).hide();
             now = (now + 1 < divs.length) ? now + 1 : 0;
            //alert(now);
        if(divs.length-1==now)
        	{
         	 divs.eq(now).show();
         	$('#prev').show();
