...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="FacultyDashboard.jsp">
...
<form action="fsettings_valid.jsp">
...
<form method="post"action="/E-learning/FacultyPicUpload"enctype="multipart/form-data">
