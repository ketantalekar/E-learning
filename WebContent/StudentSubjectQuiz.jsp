...
<div id="test">
    <%   
  int cnt=0;
  String sql = "Select Id,title,created_date,quiz_date,quiz_time,time_limit,description from quiz_info where Subject=? order by id desc";
  ...
  <tr id="mmm"><th>#</th><th>Title</th><th>Description</th><th>Created date</th><th>Quiz date</th><th>Quiz time</th><th>Time limit</th></tr>
  <% 
  while(rs.next()) 
  {
	  cnt++;
...
<tr onclick="location.href='attemptsubjectquiz.jsp?id='+<%=id%>;">
