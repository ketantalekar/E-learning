      ...
      <ul class="navbar-nav ml-auto">
       <form class=" d-sm-inline-block form-inline mr-3 mt-1 ml-md-3 my-3 my-md-10 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-silver border-1 small" autocomplete="off"id="myInput6" onkeyup="myFunction()" placeholder="Search for department" aria-label="Search" aria-describedby="basic-addon2">
...
%>
  <div id="buttonss">
     <a href="" id="buttons"data-toggle="modal" data-target="#adddepartment" class="btn-room">Add Department</a>
     <div style="margin-left:70px;color:black;margin-top:15px;position:absolute;"><h3><i class="fas fa-chalkboard-teacher" aria-hidden="true"></i>&nbsp;Departments</h3></div>
   </div>



  <div id="adddepartment" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document"> 
     ...
     <!-- login modal content -->
        <div class="modal-content" id="login-modal-content">        
          ...
          <form method="post" action="adddepartment.jsp">
          <div class="form-group">
            ...
            <div class="input-group-prepend">
                ...
                <input name="department" id="department" type="text" autocomplete="off"class="form-control input-lg" placeholder="Enter Department" required>
                 </div>                      
            </div> 
           
     <input type="submit" value="&#43; Add Department"style="background:#2980B9;color:white;outline:none;"class="btn btn-block btn-lg"><br>
...
<tr>
<th>#</th><th>Department name</th><th>Action</th></tr>

<%
String query6="Select id,department_name from departments";
int cnt=0;
...
while(rs6.next())
{
	cnt++;
	%>
	<tr><td><%=cnt%></td><td><% out.println(rs6.getString(2)); %></td>
	<td><a href="" data-toggle="modal" data-target="#E<%=rs6.getString(1)%>" class="btn btn-md"style="background:#186A3B;color:white;">Edit</a> 
	<a href="" data-toggle="modal" data-target="#D<%=rs6.getString(1)%>"class="btn btn-md"style="background:#C0392B;color:white;">Remove</a></td></tr>
	
	<div id="E<%=rs6.getString(1)%>" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document"> 
        ...
        <div class="modal-content" id="login-modal-content">        
          ...
          <div class="form-group">
            ...
            <div class="input-group-prepend">
                ...
                <input name="department" id="department" type="text" class="form-control input-lg" value="<%=rs6.getString(2)%>" required>
                 </div>   
                 </div>                   
                            <input name="did" type="hidden"  value="<%=rs6.getString(1) %>">
              <input name="dname" type="hidden"  value="<%=rs6.getString(2) %>">
             
     <button type="submit" style="background:#186A3B;color:white;"class="btn btn-block btn-lg"><i class="fas fa-edit"></i> Modify</button><br>
	...
	<div id="D<%=rs6.getString(1)%>" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-confirm" role="document"> 
     ...
     <!-- login modal content -->
      ...
      <div class="modal-footer justify-content-center">
				...
				<a href="DeleteDepartment.jsp?id=<%=rs6.getString(1)%>" style="color:white;padding-top:10px;"class="btn btn-danger">Delete</a>
			</div>
