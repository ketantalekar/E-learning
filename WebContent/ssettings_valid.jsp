...
<body>
               ...
               String currpass,newpass,repass,updat;
                ...
                if(updat.equals("Save Changes"))
            	{
        			...
        			String bs="select Password from student_details where Userid='"+session.getAttribute("sessuid")+"'";
        			st.execute(bs);
        		 ...
        		 if(!newpass.equals(repass))
           {
             			...
             			response.sendRedirect("Ssettings.jsp?error="+message);
                 	}
        		 ...
        		 else
        		 {
        			 ...
        			 int passtatus=1;
  			       int i=stmt.executeUpdate("update student_details set Password='"+newpass+"',PasswordStatus="+passtatus+"where Userid='"+session.getAttribute("sessuid")+"'");
  					if(i>0)
  					{     
  						 String message="Password Updated Successfully";
  						response.sendRedirect("Ssettings.jsp?message="+message);
  					} 
  					con1.close(); 
