...
String q1="Select Id,Title,File_name,File_data,Date,Time,DueDate,DueTime,Description from facultyassignment where Id=?";
...
{
	id=rs2.getInt(1);	
	assigntitle=rs2.getString(2);
	filename=rs2.getString(3);
	date=rs2.getString(5);
	time=rs2.getString(6);
	duedate=rs2.getString(7);
	duetime=rs2.getString(8);
	description=rs2.getString(9);
...
<span style='margin-top:5px;'><%=filename%></span></a>
 ...
 <div id="note">     
    <form method="post" id="f1" action="/E-learning/StudentUploadAssignment"enctype="multipart/form-data">
  <div id="uploadfile">
...
<input type="hidden" name="assigntitle" value="<%=assigntitle%>">
<input type="hidden" name="assignid" value="<%=id%>">
   ...
   <!--   <input type="submit" id="b1" > -->
          ...
          <input type="submit" name="submit" id="sub"value="Submit Assignment">
    </form>
    <%
    }
catch(Exception e)
