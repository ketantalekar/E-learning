...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="CollegeAdminDashboard.jsp">
...
<form action="casettings_valid.jsp">
...
<form method="post"action="/E-learning/CollegeAdminPicUpload"enctype="multipart/form-data">
<div id="panel1">Choose Photo &nbsp<input type="file" name="myimg"required><br><input id="button4"type="submit"name="update1"value="Upload"><br>
</div></form>
