...
<nav id="head">Chats</nav>  
  ...
  <div id="top-private-bar">
  <form autocomplete="off"method="post"action="StudentFacultyChatCheck.jsp">
  ...
  else
  {
	  ...
	  while(res3.next()){
	   ...
	   if(sen.equals(sender))
		  {
		   String recname="";
		      String bs1="select Username from faculty_details where Userid=?";
		      ...
		      recname=rs5.getString(1);
		   		   ...
		   		   %>
		   		   <a id="recent-chats-link"href="StudentFacultyChatCheck.jsp?people=<%=recname%>"><div id="recent-chats">
		      <img class="img-chat rounded-circle" width="95px" height="50px" src="FacultyViewImage.jsp?name=<%=rec%>">
			  <% 
		  ...
		  else if(rec.equals(sender))
		  {
			  ...
			  %>
			  <a id="recent-chats-link"href="StudentFacultyChatCheck.jsp?people=<%=senname%>"><div id="recent-chats">
		      <img class="img-chat rounded-circle" width="95px" height="50px" src="FacultyViewImage.jsp?name=<%=sen%>">
			  <% 
...
<div id="showList2">
  ...
  else
  {
	  ...
	  try
	  {
	  PreparedStatement pst=con1.prepareStatement("Select Username,Userid from  faculty_details where Userid<>?");
	  pst.setString(1,sender);
	  ...
	  while(res3.next()){
		  ...
		  %>
		  <a id="recent-chats-link"href="StudentFacultyChatCheck.jsp?people=<%=user%>">
		  <img class="img-chat rounded-circle" width="95px" height="50px" src="FacultyViewImage.jsp?name=<%=uid%>">
  ...
  {
	  %>
      <img class="img-chat rounded-circle" width="95px" height="50px" src="FacultyViewImage.jsp?name=<%=uname%>">
      <%
      String usname="";
      String bs1="select Username from faculty_details where Userid=?";
  	PreparedStatement ps5=con1.prepareStatement(bs1);
