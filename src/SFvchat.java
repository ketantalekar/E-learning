...
/**
 * Servlet implementation class SFvchat
 */
 @WebServlet(name="SFvchat",urlPatterns= {"/SFvchat"})

public class SFvchat extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int query=stmt.executeUpdate("insert into private_chat(Sender,Reciever,Message,Date,Time) values('"+sender+"','"+receiver+"','"+replaceString+"','"+strDate+"','"+dateString+"')");
		...
		{
			response.sendRedirect("FacultyStudentChat.jsp");
			
		}
		else if(utype.equals("Student"))
		{
			response.sendRedirect("StudentFacultyChat.jsp");
