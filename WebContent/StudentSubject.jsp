...
function goForward() {
  ...
  %>
      ...
      <%
     int nstatus1=0,astatus=0,qqstatus=0,ststatus=0,notitotal=0,psstatus=0,proffstatus=0,proffpicstatus=0,totalsta=0,stotal=0;
     ...
     pstmt29=con1.prepareStatement("SELECT NoticeStatus,AssignmentStatus,QuizStatus,StudyMaterial FROM student_subject WHERE Userid=?");
      ...
      while(rs29.next())
      {     
    	  nstatus1=rs29.getInt(1);
    	  astatus=rs29.getInt(2);
    	  qqstatus=rs29.getInt(3);
    	  ststatus=rs29.getInt(4);
    	  stotal=stotal+nstatus1+astatus+qqstatus+ststatus;
      }
...
%>
 ...
 <div id="notice">
 <%
      String query3="select Notice_title,Notice,Date,Id from notices where subject=? order by Id desc";
	    	 ...
	    	 <a id="notices" href="#" data-toggle="modal" data-target="#<%=titleid%>">
	    	   <i style="color:red;margin-top:-30px;font-size:26px;position:absolute;"class="fa fa-thumb-tack" aria-hidden="true"></i>
	    	    <span style="margin-left:100px;"><%out.println("<small>Date:"+date+"</small>"); %></span>
	    	        ...
	    	        <div id="notic"><%out.println(note.substring(0, Math.min(note.length(), 80))); %></div>
	    	      </a>
 ...
 <div class="modal-dialog" role="document"> 
     ...
     <!-- login modal content -->
        <div class="modal-content" id="login-modal-content">        
          ...
          <h4 class="modal-title"><% out.println(title); out.println(date);%>
