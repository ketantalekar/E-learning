...
.otable tr:hover {background-color: #ddd;}
...
$(document).ready(function() {
	  $("#sel2").change(function() {
	    ...
	    if(department != "") {
	      ...
	      $("#sel1").html("<option value=''>------- Select --------</option>");
...
<a href=""id="buttons" data-toggle="modal" data-target="#allocatesub" class="btn-room">Allocate Subject</a>
<a href=""id="buttons" data-toggle="modal" data-target="#addsubject" class="btn-room">Add Subject</a>
<div style="margin-left:70px;color:black;margin-top:15px;position:absolute;"><h3><i class="fas fa-book" aria-hidden="true"></i>&nbsp;Subjects</h3></div>
   </div>

 
   <div id="addsubject" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document"> 
     ...
     <!-- login modal content -->
        <div class="modal-content" id="login-modal-content">        
          ...
          <form method="post" action="AddSubject.jsp">
             <%
            String query8="select department_name from departments";
            ...
            <div class="form-group">
                <label for="sel">Select Department:</label>
            ...
            <div class="input-group-prepend">
                ...
                <select name="department" id="sel" class="form-control input-lg" required>
    ...
    <div class="form-group">
            ...
            <div class="input-group-prepend">
                ...
                <input name="subjectname" autocomplete="off"id="subjectname" type="text" class="form-control input-lg" placeholder="Enter Subject Name" required>
                </div>                      
            </div>
            ...
            <input type="submit" value="&#43; Add Subject"style="background:#2980B9;color:white;outline:none;"class="btn btn-block btn-lg"><br>
   ...
   <div id="allocatesub" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document"> 
     ...
     <!-- login modal content -->
        <div class="modal-content" id="login-modal-content">        
          ...
          <div class="modal-body">
          <form method="post" action="AllocateSubject.jsp">
                     <%
            String query7="select Username,Userid from faculty_details";
            PreparedStatement ps7=con1.prepareStatement(query7);
           ...
           // String isuser="";
            ...
            %>
               ...
               <div class="form-group">
                <label for="sel3">Select Faculty:</label>
                   <div class="input-group input-group-md">
            <div class="input-group-prepend">
                <span class="input-group-text">
                ...
                <select name="facultyname" id="sel3" class="form-control input-lg" required>
                <option value="">------- Select --------</option>
                 <%
               while(rs7.next())
               {
            	   ...
            	   %>
            	   <option value="<%=rs7.getString(2)%>"><%=rs7.getString(1)%>(<%=rs7.getString(2) %>)</option>
            	   <% 
               }
               %>
                </select>
  ...
  <% String query10="select department_name from departments";
     PreparedStatement ps10=con1.prepareStatement(query10);
     ResultSet rs10=ps10.executeQuery();  
     %>
            <div class="form-group">
                <label for="sel2">Select Department:</label>
                   <div class="input-group input-group-md">
            <div class="input-group-prepend">
                <span class="input-group-text">
                    <span class="fas fa-home" ></span>
                ...
                <select name="department" id="sel2" class="form-control input-lg" required>
                <option value="">------- Select --------</option>
           <%     while(rs10.next())
     {
    	 //String department=rs4.getString(1);
  	   %>
  	   <option value="<%=rs10.getString(1)%>"><%=rs10.getString(1)%></option>
  	   <% 
               }
            %>
            ...
            <div class="input-group-prepend">
                ...
                <select name="batch" id="sel1" class="form-control input-lg" required>
                 <option value="">------- Select --------</option>
              ...
              <div class="form-group">
                <label for="sel13">Select Subject Name:</label>
                   <div class="input-group input-group-md">
            <div class="input-group-prepend">
                <span class="input-group-text">
                    <span class="fas fa-book" ></span>
                ...
                <select name="subjectname" id="sel13" class="form-control input-lg"required>
                 <option value="">------- Select --------</option>
            ...
            <button type="submit" style="background:#2980B9;color:white;outline:none;"class="btn  btn-block btn-lg"><i class="fas fa-arrow-right"></i> Allocate</button><br>
...
<tr>
<th> Subject Name</th><th>Subject code</th><th>Department</th><th>Batch</th><th>Alloted</th><th>Faculty Name</th><th>Action</th></tr>

<%
String query6="Select Subject_name,Department,Batch,isAlloted,Userid,Subject_code,Id from subject_details";
String subcode="";
PreparedStatement ps6=con1.prepareStatement(query6);
ResultSet rs6=ps6.executeQuery();  
while(rs6.next())
{
	subcode=rs6.getString(6);
	%>
	<tr class="ml"><td><% out.println(rs6.getString(1)); %></td><td><% out.println(rs6.getString(6)); %></td><td><% out.println(rs6.getString(2)); %></td>
	<td><% out.println(rs6.getString(3)); %></td><td><% out.println(rs6.getString(4)); %></td>
	<td><%
	String userid=rs6.getString(5);
	String query9="Select Username,Userid from faculty_details where Userid=?";
String fname="",fid="";
	PreparedStatement ps9=con1.prepareStatement(query9);
	ps9.setString(1,userid);
	...
	while(rs9.next())
	{
		...
		fid=rs9.getString(2);
	%>	
	<a href="DeallocateFaculty.jsp?fid=<%=fid%>&subcode=<%=subcode%>"><i title="Deallocate Faculty" style="color:#455A64;"class="fa fa-times-circle" aria-hidden="true"></i></a> 
	<%=rs9.getString(1)%>
	<%
}
	%>
	<td><a class="btn btn-md"style="background:#186A3B;color:white;" data-toggle="modal" data-target="#E<%=rs6.getString(6)%>" href="">Edit</a> 
	<a href="" data-toggle="modal" data-target="#D<%=rs6.getString(7)%>"class="btn btn-md"style="background:#C0392B;color:white;">Remove</a></td></tr>
		<div id="E<%=rs6.getString(6)%>" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document"> 
     ...
     <!-- login modal content -->
        <div class="modal-content" id="login-modal-content">        
          ...
          <div class="modal-body">
           ...
           <form method="post" action="EditSubject.jsp">
             <% String query12="select department_name from departments";
     PreparedStatement ps12=con1.prepareStatement(query12);
     ResultSet rs12=ps12.executeQuery();  
     %>
            <div class="form-group">
                <label for="sel9">Select Department:</label>
                   <div class="input-group input-group-md">
            <div class="input-group-prepend">
                <span class="input-group-text">
                    <span class="fas fa-home" ></span>
                ...
                <select name="department" id="sel9" class="form-control input-lg" required>
  	       ...
  	       <%     while(rs12.next())
     {
  	   ...
  	   <% 
            ...
            <div class="input-group-prepend">
                ...
                <input name="subjectname" autocomplete="off"id="subjectname" type="text" class="form-control input-lg" value="<%=rs6.getString(1) %>" required>
            ...
            <div class="input-group-prepend">
             ...
             <input name="batch" id="batch"autocomplete="off" type="text" class="form-control input-lg" value="<%=rs6.getString(3) %>" required>
                 </div>  
                 </div>                    
            
           <input type="hidden" value="<%=subcode%>" name="subcode">
          
              <button type="submit" class="btn btn-block btn-lg"style="background:#186A3B;color:white;"><i class="fas fa-edit"></i> Modify</button><br>
          </form>
                </div>
...
<div id="D<%=rs6.getString(7)%>" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-confirm" role="document"> 
     ...
     <!-- login modal content -->
      ...
      <div class="modal-footer justify-content-center">
				...
				<a href="DeleteSubject.jsp?id=<%=rs6.getString(7)%>" style="color:white;padding-top:10px;"class="btn btn-danger">Delete</a>
			</div>
