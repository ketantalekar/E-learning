...
%>
 ...
 int cntfac=0;
 int clgad=0;
 int cntst=0,ttlst=0,ttlfac=0,ttl=0;
  pstmt55=con.prepareStatement("SELECT count(college_id) FROM college_details");
  ResultSet rs55=pstmt55.executeQuery();
  if(rs55.next())
  {
	  countclg=rs55.getInt(1);
  }
  %>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Registered Colleges:</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><%=countclg %></div>
                    </div>
                    <div class="col-auto">
  ...
  //out.println(""+countclg);
 try
 {
  String sql = "Select college_code from college_details ";
  PreparedStatement pstm = con.prepareStatement(sql);
  String ccode="";
  ResultSet rs = pstm.executeQuery();
  String sql1 = "Select count(Id) from college_admin_details ";
  ...
  while(rs.next())
  {
	 ...
	 con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/E"+ccode,"root","");
  ...
  <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Registered<br> Users:</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><%=ttl %></div>
                    </div>
                    <div class="col-auto">
   ...
   <div class="col-xl-3 col-md-6 mb-4">
             <div class="card border-left-info shadow h-100 py-2">
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Registered Faculty Members</div>
                     <div class="h5 mb-0 font-weight-bold text-gray-800"><%=ttlfac %></div>
                   </div>
                   <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><%=ttlst%></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-chalkboard-teacher fa-2x text-gray-300"></i>
                    </div>
