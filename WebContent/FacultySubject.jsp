...
<title>My Subject Notices</title>
...
%>
 <div style="margin-left:30px;color:black;margin-top:8px;position:absolute;"><h3><i class="fas fa-chalkboard-teacher" aria-hidden="true"></i>&nbsp;My Notices</h3></div>
 <div id="notice">
                 <br><br>
   <div style="margin-top:-0px;">
    <a id="notices" data-toggle="modal" data-target="#addnotice"href="#">
   <i style="color:red;margin-top:-30px;font-size:26px;position:absolute;"class="fa fa-thumb-tack" aria-hidden="true"></i>
        <h2>Add new Notice</h2>
        <p id="addnewnotice"><i class="fa fa-plus" aria-hidden="true"></i></p>
      </a>
 <%   
      String query3="select Notice_title,Notice,Date,Id from notices where Subject=? and Faculty_name=? order by Id desc";
 String faculty_name=(String)session.getAttribute("sessuid");
 String title="";
 String date="";
 String note="";
 int Id;
 int ln;
	     ...
	     ps4.setString(2,faculty_name);
	     ResultSet rs4=ps4.executeQuery();
	     while(rs4.next())
	     {
	    	 title=rs4.getString(1);
	    	 note=rs4.getString(2);
	    	 ...
	    	 {
	    		%> 
	    		<a id="notices"style="margin-top:10px;"href="#" data-toggle="modal" data-target="#<%=titleid%>">
	    	   <i style="color:red;margin-top:-30px;font-size:26px;position:absolute;"class="fa fa-thumb-tack" aria-hidden="true"></i>
	    	    <span style="margin-left:100px;"><%out.println("<small>Date:"+date+"</small>"); %></span>
	    	        <h2><%out.println(title); %></h2>
	    	        <div id="notic"><%out.println(note.substring(0, Math.min(note.length(), 38))); %><span style="color:transparent;">hhhuhuhuhuhuhhhhhdhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh</span></div>
	    	      </a>
	    	<%	 
	    	 }
	    	 else
	    	 ...
	    	 <a id="notices"href="#"data-toggle="modal" data-target="#<%=titleid%>">
	    	   <i style="color:red;margin-top:-30px;font-size:26px;position:absolute;"class="fa fa-thumb-tack" aria-hidden="true"></i>
	    	    <span style="margin-left:100px;"><%out.println("<small>Date:"+date+"</small>"); %></span>
	    	        <h2><%out.println(title); %></h2>
	    	        <div id="notic"><%out.println(note.substring(0, Math.min(note.length(), 80))); %><span style="color:transparent;">hhhhuuuyshjs</span></div>
	    	      </a>
	    	      <%
	    	      }%>
	    	      
	   <div id="<%=titleid %>" class="modal" tabindex="-1" role="dialog">
 ...
 <div class="modal-dialog" role="document"> 
     ...
     <!-- login modal content -->
        ...
        <a data-toggle="modal" data-target="#editnotice"href="#" data-dismiss="modal"class="btn btn-lg btn-primary">Edit</a>
        
        <a data-toggle="modal" data-target="#D<%=Id%>"data-dismiss="modal"href="" class="btn btn-lg btn-danger">Delete</a>
...
<div id="editnotice" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document"> 
     ...
     <!-- login modal content -->
        <div class="modal-content" id="login-modal-content">        
          ...
          <form method="post" action="EditNotice.jsp">
            <div class="form-group">
                ...
                <input name="noticetitle"autocomplete="off" id="noticetitle" type="text" class="form-control input-lg" value="<%=title %>" required>
                </div>                      
            </div>
            <div class="form-group">
                 <div class="input-group-prepend">
                ...
                <input name="noticee" autocomplete="off"id="noticee" type="text" class="form-control input-lg" value="<%=note %>" required>
                 </div>                      
            </div>       
            <input type="hidden" value="<%=Id%>" name="noticeid">
...
<div id="D<%=Id%>" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-confirm" role="document"> 
     ...
     <!-- login modal content -->
        <div class="modal-content" id="login-modal-content">        
          ...
          <div class="modal-body">
          <p>Do you really want to delete this notice? This process cannot be undone.</p>
      </div>
      <div class="modal-footer justify-content-center">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
				<a href="DeleteNotice.jsp?Id=<%=Id%>" style="color:white;padding-top:10px;"class="btn btn-danger">Delete</a>
			</div>
 ...
 %>  
   ...
   <div id="addnotice" class="modal" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document"> 
        ...
        <div class="modal-content" id="login-modal-content">        
          ...
          <form method="post" action="AddNotice.jsp">
            ...
            <div class="input-group-prepend">
                ...
                <input name="noticetitle"autocomplete="off" id="noticetitle" type="text" class="form-control input-lg" placeholder="Enter Title" required>
                </div>                      
            </div>
            <div class="form-group">
                       <div class="input-group input-group-md">
            <div class="input-group-prepend">
                ...
                <input name="noticee" autocomplete="off"id="noticee" type="text" class="form-control input-lg" placeholder="Enter Notice" required>
                 </div>                      
            </div>       
            
              <input type="submit" value="Add Notice"class="btn btn-success btn-block btn-lg">
          </form>
        </div>
