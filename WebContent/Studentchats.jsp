    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="StudentClass.jsp">
          ...
          PreparedStatement pst21=con1.prepareStatement(query);
          pst21.setString(1,user8);
          ResultSet rst21=pst21.executeQuery();
          if(rst21.next())
          {
          out.println(rst21.getString(1));
          }
          %>
          ...
          <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="StudentViewImage.jsp?name=<%=user8%>">
              </a>
...
<nav id="head">Groups</nav>  
     ...
     <a href="javascript:void(0)" class="closebtn" onclick="closeNav();document.getElementById('myInput').value='';">×</a></div>
...
function closeNav() {
  ...
  {
	  window.location.replace("Studentchats.jsp");
