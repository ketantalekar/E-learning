...
%>
  ...
  <div style="margin-left:180px;"class="container">
    <div class="row">
        <div class="col-8 mt-3">
            <div class="card border border-dark">
            <form action="VendorProfileValidation.jsp" method="post">
                   
                <div class="card-horizontal">
                    <div class="img-square-wrapper">
                        <img class="img-card" src="viewimage.jsp?name=<%=pname%>">
              
                    </div>
                    <div class="card-body">
                        <h3 class="card-title"><b>My Profile</b></h3>
                        <%
                        String query="Select Username,Userid,Email_id,Date_of_Joining from admin_details where Userid=?";
                        PreparedStatement ps5=con.prepareStatement(query);
                        ps5.setString(1,pname);
                        ResultSet rs5=ps5.executeQuery();
                        String uname="",email="",doj="";
                        if(rs5.next())
                        {
                       // out.println(rs5.getString(1));
                       uname=rs5.getString(1);
                       email=rs5.getString(3);
                       doj=rs5.getString(4);
                       ...
                       <p class="card-text">
                        ...
                        <input type="email" autocomplete="off"name="emailid" value="<%=email %>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"title="Valid Email Id required"id="text-box"></div>
...
{
	%>
	 <nav style="margin-left:200px;margin-top:-45px;line-height:45px;width:450px;background:#A9DFBF;color:#229954;">
	<%
...
{
	%>
	 <nav style="margin-left:200px;margin-top:-45px;line-height:45px;width:450px;background:#E6B0AA;color:#C0392B;">
	<%
