...
%>
  ...
  try
  {
  int cntass=0,cntquiz=0,cntnoti=0,cntfile=0;
  String subscode="",subsname="";
  String sql5 = "Select Subject_code,Subject_name from subject_details where Userid=?";
  PreparedStatement pstm5 = con1.prepareStatement(sql5);
 pstm5.setString(1,(String)session.getAttribute("sessuid"));
  ResultSet rs5 = pstm5.executeQuery();
  while(rs5.next())
  {
	  subscode=rs5.getString(1);
	  subsname=rs5.getString(2);
	//  out.println("");
		
	  %>
	  <div class='text-dark font-weight-bold'><%=subsname%>
	   <a style="text-decoration:none;"data-toggle="collapse" data-target="#S<%=subscode %>" aria-expanded="false" aria-controls="collapse-projects">
    <i class="fa fa-caret-down" aria-hidden="true"></i>
      </a>
	  
	  </div>
	   <div class="row collapsed" id="S<%=subscode%>">
	  
	  <% 
	  
  String sql4 = "Select count(Id) from facultyassignment where Userid=? and Subject_code=?";
  PreparedStatement pstm4 = con1.prepareStatement(sql4);
 pstm4.setString(1,(String)session.getAttribute("sessuid"));
 pstm4.setString(2,subscode);
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Assignments Uploaded</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><%=cntass %></div>
                    </div>
                    <div class="col-auto">
  ...
  <% 
 // out.println("assignment:"+cntass);
  
 	//  out.println("Quiz");
		
  String sql3 = "Select count(Id) from quiz_info where Faculty_Name=? and subject=?";
  PreparedStatement pstm3 = con1.prepareStatement(sql3);
 pstm3.setString(1,(String)session.getAttribute("sessuid"));
 pstm3.setString(2,subscode);
  ResultSet rs3 = pstm3.executeQuery();
  if(rs3.next())
  {
	  cntquiz=rs3.getInt(1); 
  }
  %>
  <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Quiz Conducted</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><%=cntquiz %></div>
                    </div>
                    <div class="col-auto">
  ...
  <% 
 // out.println("Subject:"+cntquiz);
 //out.println("Notice");	  
  String sql6 = "Select count(Id) from notices where Faculty_Name=? and subject=?";
  PreparedStatement pstm6 = con1.prepareStatement(sql6);
 pstm6.setString(1,(String)session.getAttribute("sessuid"));
 pstm6.setString(2,subscode);
  ResultSet rs6 = pstm6.executeQuery();
  if(rs6.next())
  {
	  cntnoti=rs6.getInt(1); 
  }
  %>
   <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Notices Uploaded</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><%=cntnoti %></div>
                    </div>
                    <div class="col-auto">
  ...
  <% 
 // out.println("No of Notices Added:"+cntnoti);
 
    String sql7 = "Select count(Id) from upload_file where Userid=? and Subject_Name=?";
  PreparedStatement pstm7 = con1.prepareStatement(sql7);
 pstm7.setString(1,(String)session.getAttribute("sessuid"));
 pstm7.setString(2,subscode);
  ResultSet rs7 = pstm7.executeQuery();
  if(rs7.next())
  {
	  cntfile=rs7.getInt(1); 
  }
  //out.println("No of Files Uploaded:"+cntfile);
  %>
  <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><%=cntfile%></div>
                    </div>
                    <div class="col-auto">
