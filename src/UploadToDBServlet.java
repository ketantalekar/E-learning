...
@WebServlet(name="UploadToDBServlet",urlPatterns= {"/UploadToDBServlet"})
...
public class UploadToDBServlet extends HttpServlet {
	        ...
	        for (Part part : request.getParts()) {
                ...
                if (fileName != null && fileName.length() > 0) {
                   ...
                   out.println("hii");
                    ...
                    this.writeToDB(con, fileName, is,coursename);
                    }
                
                }
            }
	        response.sendRedirect("vcourses.jsp?message=Course+Added+Successfully");
	        }
	        catch (Exception e) {
	            e.printStackTrace();
	...
	private void writeToDB(Connection con, String fileName, InputStream is, String coursename) throws SQLException {
		 
        String sql = "Insert into courses(coursename,file_name,file_data) values (?,?,?) ";
