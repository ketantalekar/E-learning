    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="StudentClass.jsp">
          ...
          String query21="select college_name from college_details where college_code=?";
          PreparedStatement ps21=con.prepareStatement(query21);
          ps21.setString(1,collegename);
          String clgname="";
          ResultSet rs60=ps21.executeQuery();
          while(rs60.next())
          {
        	  clgname=rs60.getString(1);
          out.println(rs60.getString(1));
          }
          %>
...
<div class="container">
    <div class="row">
        <div class="col-10 mt-0">
            ...
            <form action="StudentProfileValidation.jsp" method="post">
                   
                <div class="card-horizontal">
                    <div class="img-square-wrapper">
                        <img class="img-card" src="StudentViewImage.jsp?name=<%=user%>">
              
                    </div>
                    <div class="card-body">
                        <h3 class="card-title"><b>My Profile</b></h3>
                        <%
                        String query2="Select Username,Userid,Email_Id,Address,Mobile_No,Batch,Department,College_code,Roll_no from student_details where Userid=?";
                        PreparedStatement ps6=con1.prepareStatement(query2);
                        ps6.setString(1,user);
                        ResultSet rs6=ps6.executeQuery();
                        String uname="",email="",address="",mobileno="",dept="",code="",batch="",rollno="";
                        if(rs6.next())
                        {
                       // out.println(rs5.getString(1));
                       uname=rs6.getString(1);
                       email=rs6.getString(3);
                       address=rs6.getString(4);
                      mobileno=rs6.getString(5);
                      batch=rs6.getString(6);
                      dept=rs6.getString(7);
                      code=rs6.getString(8);
                      rollno=rs6.getString(9);
                        }
                        %>
                        <p class="card-text">
                        ...
                        <input type="text" pattern="^[a-zA-Z ]+$"title="This field contains only alphabets"autocomplete="off"name="uname" value="<%=uname %>" id="text-box"></div>
                        </p>
                        <p class="card-text">
                           <div class="sub-title">Userid </div>
                             <div class="input-value">
                      
                        <input type="text" autocomplete="off"name="uid" value="<%=(String)session.getAttribute("sessuid") %>" id="text-box" readonly></div>
                      
                         </p>
                          <p class="card-text">
                           <div class="sub-title"> Roll Number </div>
                             <div class="input-value">
                      
                        <input type="text" autocomplete="off"name="rollno" value="<%=rollno %>" id="text-box"></div>
                       ...
                       <p class="card-text">
                        ...
                        <input type="email" autocomplete="off"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"title="Valid Email Id required"name="emailid" value="<%=email %>" id="text-box"></div>
                      ...
                      <p class="card-text">
                        ...
                        <input type="text" autocomplete="off"name="address" value="<%=address %>" id="text-box"></div>
                      
                         </p>
                       <p class="card-text">
                           <div class="sub-title">Mobile Number </div>
                             <div class="input-value">
                      
                        <input type="text" autocomplete="off"pattern="[0-9]{10}"title="Valid Contact no required"name="mobileno" value="<%=mobileno %>" id="text-box"></div>
                      ...
                      <p class="card-text">
                        ...
                        <input type="text" autocomplete="off"name="dept" value="<%=dept %>" id="text-box" readonly></div>
                      
                         </p>
                      <p class="card-text">
                           <div class="sub-title"> Batch </div>
                             <div class="input-value">
                      
                        <input type="text" autocomplete="off"name="batch" value="<%=batch %>" id="text-box" readonly></div>
                      
                         </p>
                     
                      <p class="card-text">
                           <div class="sub-title"> College code </div>
                             <div class="input-value">
                      
                        <input type="text" autocomplete="off"name="code" value="<%=code %>" id="text-box" readonly></div>
                      
                         </p>
                      <p class="card-text">
                           <div class="sub-title"> College Name </div>
                             <div class="input-value">
                      
                        <input type="text" autocomplete="off"name="clgname" value="<%=clgname %>" id="text-box" readonly></div>
                ...
                <div class="card-footer">
                    <small class="text-muted"><input type="submit" value="Save Changes" class="btn btn-primary btn-lg"></small>
...
{
	%>
	 <nav style="margin-left:200px;margin-top:-45px;line-height:45px;width:620px;background:#A9DFBF;color:#229954;">
	<%
...
{
	%>
	 <nav style="margin-left:200px;margin-top:-45px;line-height:45px;width:620px;background:#E6B0AA;color:#C0392B;">
	<%
