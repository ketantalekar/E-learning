  ...
  <div class="container">
    <div class="row">
        <div class="col-10 mt-3">
            ...
            <form action="FacultyProfileValidation.jsp" method="post">
                   <%  String user=(String)session.getAttribute("sessuid");
                   %>
                <div class="card-horizontal">
                    <div class="img-square-wrapper">
                        <img class="img-card" src="FacultyViewImage.jsp?name=<%=user%>">
              
                    </div>
                    <div class="card-body">
                        <h3 class="card-title"><b>My Profile</b></h3>
                        <%
                        String query2="Select Username,Userid,Email_Id,Address,Mobile_No,College_code from faculty_details where Userid=?";
                        PreparedStatement ps6=con1.prepareStatement(query2);
                        ps6.setString(1,user);
                        ResultSet rs6=ps6.executeQuery();
                        String uname="",email="",address="",mobileno="",code="";
                        if(rs6.next())
                        {
                      ...
                      code=rs6.getString(6);
                        ...
                        <input type="text" autocomplete="off"pattern="^[a-zA-Z ]+$"title="This field contains only alphabets"name="uname" value="<%=uname %>" id="text-box"></div>
                        </p>
                        <p class="card-text">
                      ...
                      <p class="card-text">
                       ...
                       <p class="card-text">
                        ...
                        <input type="text" autocomplete="off"name="mobileno" pattern="[0-9]{10}"title="Valid Contact no required"value="<%=mobileno %>" id="text-box"></div>
